...
$configs = {
	...
	# footer area
	:footer_text 		=> "Report generated by <a href='https://github.com/chrisallenlane/watchtower'>Watchtower</a>.<br>For more information, please see:<br><a href='https://www.owasp.org/index.php/DOM_based_XSS_Prevention_Cheat_Sheet'>OWASP DOM Based XSS Prevention cheat Sheet</a>
<br><a href='https://developer.mozilla.org/en-US/'>Mozilla Developer Network</a><br><a href='https://developer.mozilla.org/en-US/docs/Web/Apps/Security_guidelines'>Firefox OS Security Guidelines</a> ",
